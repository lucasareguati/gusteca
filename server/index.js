...
sequelize.query(`CREATE VIEW factura as select compra.id_compra, pl.modelo, pl.linea, pl.diametro, carrito.cantidad, pl.precio from platillo pl, carro, carrito, compra where compra.id_carro = carro.id_carro and carro.id_carrito = carrito.id_carrito and pl.id_platillo = carrito.id_platillo and compra.estado = ${'Pagado'}`);
*/
